...
def main():
    parser = argparse.ArgumentParser(description="Bank Data Simulator CLI")
    parser.add_argument(
        "--n-customers", type=int, default=1000, help="Number of customers to generate"
    )
    parser.add_argument(
        "--sim-months", type=int, default=24, help="Number of simulation months"
    )
